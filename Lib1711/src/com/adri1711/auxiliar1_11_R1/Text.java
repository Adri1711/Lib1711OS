...
import com.adri1711.auxiliar1_11_R1.HoverAction;
import com.adri1711.auxiliar1_11_R1.Text;

public class Text extends net.minecraft.server.v1_11_R1.ChatComponentText {
    ...
    public Text append(net.minecraft.server.v1_11_R1.IChatBaseComponent node) {
        return (Text) addSibling(node);
    }

    public Text append(net.minecraft.server.v1_11_R1.IChatBaseComponent... nodes) {
        for (net.minecraft.server.v1_11_R1.IChatBaseComponent node : nodes) {
            addSibling(node);
        }
    ...
    public net.minecraft.server.v1_11_R1.ChatClickable getChatClickable() {
        return getChatModifier().h();
    }

    public Text setClick(ClickAction action, String value) {
        getChatModifier().setChatClickable(new net.minecraft.server.v1_11_R1.ChatClickable(action.getNMS(), value));
        return this;
    }
    ...
    public net.minecraft.server.v1_11_R1.ChatHoverable getChatHoverable() {
        return getChatModifier().i();
    }

    public Text setHover(HoverAction action, net.minecraft.server.v1_11_R1.IChatBaseComponent value) {
        getChatModifier().setChatHoverable(new net.minecraft.server.v1_11_R1.ChatHoverable(action.getNMS(), value));
        return this;
    }
    ...
    public Text setHoverText2(String[] text,String nombre) {
        ...
        nms.save(tag);
        setHover(HoverAction.SHOW_ITEM, new net.minecraft.server.v1_11_R1.ChatComponentText(tag.toString()));
        return this;
    }
    ...
    @Override
    public net.minecraft.server.v1_11_R1.IChatBaseComponent f() {
        return h();
    }
