...
public class Trans extends net.minecraft.server.v1_9_R2.ChatMessage {
    ...
    public Trans append(net.minecraft.server.v1_9_R2.IChatBaseComponent node) {
        return (Trans) addSibling(node);
    }

    public Trans append(net.minecraft.server.v1_9_R2.IChatBaseComponent... nodes) {
    ...
    public Trans setHover(HoverAction action, net.minecraft.server.v1_9_R2.IChatBaseComponent value) {
