...
import com.adri1711.auxiliar1_8_R3.HoverAction;
import com.adri1711.auxiliar1_8_R3.Text;

public class Text extends net.minecraft.server.v1_8_R3.ChatComponentText {
    ...
    public Text append(net.minecraft.server.v1_8_R3.IChatBaseComponent node) {
        return (Text) addSibling(node);
    }

    public Text append(net.minecraft.server.v1_8_R3.IChatBaseComponent... nodes) {
    ...
    public Text setHover(HoverAction action, net.minecraft.server.v1_8_R3.IChatBaseComponent value) {
    ...
    public Text setHoverText2(String[] text,String nombre) {
        ...
        nms.save(tag);
        setHover(HoverAction.SHOW_ITEM, new net.minecraft.server.v1_8_R3.ChatComponentText(tag.toString()));
        return this;
    }
