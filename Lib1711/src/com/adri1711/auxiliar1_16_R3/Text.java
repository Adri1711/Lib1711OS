...
import net.minecraft.server.v1_16_R3.ChatModifier.ChatModifierSerializer;
import net.minecraft.server.v1_16_R3.EnumChatFormat;

public class Text extends net.minecraft.server.v1_16_R3.ChatComponentText {
	...
	public Text append(net.minecraft.server.v1_16_R3.IChatBaseComponent node) {
		return (Text) addSibling(node);
	}

	public Text append(net.minecraft.server.v1_16_R3.IChatBaseComponent... nodes) {
		for (net.minecraft.server.v1_16_R3.IChatBaseComponent node : nodes) {
			addSibling(node);
		}
	...
	public net.minecraft.server.v1_16_R3.ChatClickable getChatClickable() {
		return getChatModifier().getClickEvent();
	}

	public Text setClick(ClickAction action, String value) {
		net.minecraft.server.v1_16_R3.ChatClickable cc = new net.minecraft.server.v1_16_R3.ChatClickable(
				action.getNMS(), value);
	...
	public net.minecraft.server.v1_16_R3.ChatHoverable getChatHoverable() {
		return getChatModifier().getHoverEvent();
	}

	public Text setHover(HoverAction action, net.minecraft.server.v1_16_R3.IChatBaseComponent value) {
		return this;
	}
	...
	public Text setHover(HoverAction action, net.minecraft.server.v1_16_R3.IChatBaseComponent value,
		...
		ChatHoverable ch = new net.minecraft.server.v1_16_R3.ChatHoverable(EnumHoverAction.SHOW_ITEM,
