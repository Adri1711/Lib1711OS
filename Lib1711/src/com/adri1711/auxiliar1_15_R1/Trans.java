...
public class Trans extends net.minecraft.server.v1_15_R1.ChatMessage {
    ...
    public Trans append(net.minecraft.server.v1_15_R1.IChatBaseComponent node) {
        return (Trans) addSibling(node);
    }

    public Trans append(net.minecraft.server.v1_15_R1.IChatBaseComponent... nodes) {
    ...
    public Trans setHover(HoverAction action, net.minecraft.server.v1_15_R1.IChatBaseComponent value) {
        getChatModifier().setChatHoverable(new net.minecraft.server.v1_15_R1.ChatHoverable(action.getNMS(), value));
        return this;
    }
