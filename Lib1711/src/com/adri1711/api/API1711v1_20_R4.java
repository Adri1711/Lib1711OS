...
import com.adri1711.auxiliar1_20_R4.GsonFactory;
import com.adri1711.auxiliar1_20_R4.Text;
import com.adri1711.auxiliar1_20_R4.Util;
import com.adri1711.util.FastBoard;
import com.adri1711.util.Util1;
import com.adri1711.util.Utils1_20_4;
...
public class API1711v1_20_R4 extends AbstractAPI1711<Text> {
	private String id; 
	private Gson gson;

	public API1711v1_20_R4(String id, String pl) {
		this.id = id;
		this.pl = pl;
...
//		Util.send(player, (IChatBaseComponent) firstText, ChatPosition.CHAT);
	...
	public  Boolean isCraftHorse(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_20_R4.entity.CraftHorse;
	}
	@Override
	public  Boolean isCraftEnderPearl(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_20_R4.entity.CraftEnderPearl;
	}
	@Override
	public  Boolean isCraftItem(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_20_R4.entity.CraftItem;

	}
	@Override
	public  Boolean isCraftBoat(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_20_R4.entity.CraftBoat;
	}
	@Override
	...
	public void usaTitle(Player p, String title, String subtitle) {
		Utils1_20_4.usaTitle(p, title, subtitle);
	}
	...
	public void cambiaNombre(Player p, String nuevoNombre, List<Player> players) {
		Utils1_20_4.cambiaNombre(p, nuevoNombre, players);
	}
