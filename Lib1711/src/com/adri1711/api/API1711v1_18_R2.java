...
import com.adri1711.auxiliar1_18_R2.ChatPosition;
import com.adri1711.auxiliar1_18_R2.ClickAction;
import com.adri1711.auxiliar1_18_R2.GsonFactory;
import com.adri1711.auxiliar1_18_R2.Text;
import com.adri1711.auxiliar1_18_R2.Util;
import com.adri1711.util.FastBoard;
import com.adri1711.util.Util1;
import com.adri1711.util.Utils1_18_2;
...
public class API1711v1_18_R2 extends AbstractAPI1711<Text> {
	private String id;
	private Gson gson;

	public API1711v1_18_R2(String id, String pl) {
		this.id = id;
		this.pl = pl;
	...
	public  Boolean isCraftHorse(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_18_R2.entity.CraftHorse;
	}
	@Override
	public  Boolean isCraftEnderPearl(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_18_R2.entity.CraftEnderPearl;
	}
	@Override
	public  Boolean isCraftItem(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_18_R2.entity.CraftItem;

	}
	@Override
	public  Boolean isCraftBoat(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_18_R2.entity.CraftBoat;
	}
	@Override
	...
	public void usaTitle(Player p, String title, String subtitle) {
		Utils1_18_2.usaTitle(p, title, subtitle);
	}
	...
	public void cambiaNombre(Player p, String nuevoNombre, List<Player> players) {
		Utils1_18_2.cambiaNombre(p, nuevoNombre, players);
	}
