...
import com.adri1711.auxiliar1_16_R3.ChatPosition;
import com.adri1711.auxiliar1_16_R3.ClickAction;
import com.adri1711.auxiliar1_16_R3.GsonFactory;
import com.adri1711.auxiliar1_16_R3.Text;
import com.adri1711.auxiliar1_16_R3.Util;
import com.adri1711.util.FastBoard;
import com.adri1711.util.Util1;
import com.adri1711.util.Utils1_16_3;
...
public class API1711v1_16_R3 extends AbstractAPI1711<Text> {
	private String id;
	private Gson gson;

	public API1711v1_16_R3(String id, String pl) {
		this.id = id;
		this.pl = pl;
	...
	public  Boolean isCraftHorse(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_16_R3.entity.CraftHorse;
	}
	@Override
	public  Boolean isCraftEnderPearl(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_16_R3.entity.CraftEnderPearl;
	}
	@Override
	public  Boolean isCraftItem(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_16_R3.entity.CraftItem;

	}
	@Override
	public  Boolean isCraftBoat(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_16_R3.entity.CraftBoat;
	}
	@Override
	...
	public void forceBreakBlock(Player p, Double x, Double y, Double z) {
		((org.bukkit.craftbukkit.v1_16_R3.entity.CraftPlayer) p).getHandle().playerInteractManager
				.breakBlock(new net.minecraft.server.v1_16_R3.BlockPosition(x, y, z));
	}
	@Override
	...
	public void convertBlock(Location l, MaterialData data) {
		...
		if (data.getData() != Byte.valueOf("0").byteValue()) {
			...
			try {
				org.bukkit.craftbukkit.v1_16_R3.block.CraftBlockState cbs = new org.bukkit.craftbukkit.v1_16_R3.block.CraftBlockState(
						l.getBlock());
				cbs.setData(data);
			...
			try {
				org.bukkit.craftbukkit.v1_16_R3.block.CraftBlock cb = (org.bukkit.craftbukkit.v1_16_R3.block.CraftBlock) l
						.getBlock();
	...
	public void usaTitle(Player p, String title, String subtitle) {
		Utils1_16_3.usaTitle(p, title, subtitle);
	}
	...
	public void cambiaNombre(Player p, String nuevoNombre, List<Player> players) {
		Utils1_16_3.cambiaNombre(p, nuevoNombre, players);
	}
