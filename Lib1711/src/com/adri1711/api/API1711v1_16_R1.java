...
import com.adri1711.auxiliar1_16_R1.ChatPosition;
import com.adri1711.auxiliar1_16_R1.ClickAction;
import com.adri1711.auxiliar1_16_R1.GsonFactory;
import com.adri1711.auxiliar1_16_R1.Text;
import com.adri1711.auxiliar1_16_R1.Util;
import com.adri1711.util.FastBoard;
import com.adri1711.util.Util1;
import com.adri1711.util.Utils1_16_1;
...
public class API1711v1_16_R1 extends AbstractAPI1711<Text> {
	private String id;
	private Gson gson;

	public API1711v1_16_R1(String id, String pl) {
		this.id = id;
		this.pl = pl;
	...
	public  Boolean isCraftHorse(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_16_R1.entity.CraftHorse;
	}
	@Override
	public  Boolean isCraftEnderPearl(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_16_R1.entity.CraftEnderPearl;
	}
	@Override
	public  Boolean isCraftItem(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_16_R1.entity.CraftItem;

	}
	@Override
	public  Boolean isCraftBoat(Object e) {
		return e instanceof org.bukkit.craftbukkit.v1_16_R1.entity.CraftBoat;
	}
	@Override
	...
	public void forceBreakBlock(Player p, Double x, Double y, Double z) {
		((org.bukkit.craftbukkit.v1_16_R1.entity.CraftPlayer) p).getHandle().playerInteractManager
				.breakBlock(new net.minecraft.server.v1_16_R1.BlockPosition(x, y, z));
	}
	@Override
	public void convertBlock(Location l, MaterialData data) {
		...
		if (data.getData() != Byte.valueOf("0").byteValue()) {
			...
			try {
				org.bukkit.craftbukkit.v1_16_R1.block.CraftBlockState cbs = new org.bukkit.craftbukkit.v1_16_R1.block.CraftBlockState(
						l.getBlock());
				cbs.setData(data);
			...
			try {
				org.bukkit.craftbukkit.v1_16_R1.block.CraftBlock cb = (org.bukkit.craftbukkit.v1_16_R1.block.CraftBlock) l
						.getBlock();
	...
	public void usaTitle(Player p, String title, String subtitle) {
		Utils1_16_1.usaTitle(p, title, subtitle);
	}
	...
	public  void cambiaNombre(Player p,String nuevoNombre, List<Player> players){
		Utils1_16_1.cambiaNombre(p, nuevoNombre, players);
	}
	@Override
	public Material getMaterial(AMaterials material){
		return material.getMaterial1_16();
	}
	@Override
